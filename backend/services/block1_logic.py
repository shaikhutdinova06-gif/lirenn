...
async def process_block1(data):
    ...
    if image:
        ...
        reject_keywords = [
            ...
            "не почва", "не является почвой", "это не почва", "не образец почвы"
        ]
