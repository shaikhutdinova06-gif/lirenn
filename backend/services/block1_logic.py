...
async def process_block1(data):
    ...
    if images and len(images) > 0:
        ...
        # Дополнительная проверка на ключевые слова не-почвы (fallback)
        reject_keywords = [
            # Животные
            "кот", "кошка", "собака", "животное", "пес", "щенок", "кошечка", "котята",
            "птица", "попугай", "канарейка", "голубь", "ворона", "синица", "воробей",
            "рыба", "аквариум", "аквариумный", "змея", "ящерица", "черепаха", "хомяк", "морская свинка",
            "кролик", "корова", "лошадь", "овца", "коза", "свинья", "курица", "утка", "гусь",
            "человек", "лицо", "голова", "рука", "нога", "палец", "глаз", "рот", "нос", "ухо",
            "волосы", "борода", "усы", "губа", "щека", "лоб", "подбородок",
            # Части тела животных
            "шерсть", "ус", "хвост", "лапа", "коготь", "клык", "мех", "перо",
            "крыло", "плавник", "чешуя", "панцирь", "рог", "копыто",
            # Мебель и предметы быта
            "мебель", "стул", "стол", "диван", "кресло", "шкаф", "тумба", "комод",
            "кровать", "матрас", "подушка", "одеяло", "простыня", "покрывало",
            "ковёр", "коврик", "штора", "занавеска", "жалюзи", "лампа", "торшер",
            "люстра", "бра", "светильник", "ваза", "картина", "рамка", "зеркало",
            "часы", "будильник", "телефон", "компьютер", "ноутбук", "монитор", "клавиатура", "мышь",
            # Техника и транспорт
            "машина", "автомобиль", "авто", "грузовик", "автобус", "трамвай", "троллейбус", "метро",
            "поезд", "вагон", "платформа", "станция", "аэропорт", "самолёт", "вертолёт",
            "корабль", "лодка", "катер", "яхта", "велосипед", "мотоцикл", "скутер",
            "телефон", "смартфон", "планшет", "плеер", "наушники", "колонки",
            "телевизор", "монитор", "экран", "дисплей", "камера", "фотоаппарат",
            # Здания и строения
            "дом", "здание", "квартира", "офис", "магазин", "кафе", "ресторан",
            "гостиница", "отель", "больница", "школа", "университет", "библиотека",
            "музей", "театр", "кино", "стадион", "церковь", "храм", "мечеть",
            "фабрика", "завод", "склад", "гараж", "паркинг", "ангара",
            "башня", "мост", "тоннель", "дорога", "улица", "площадь", "парк",
            # Еда и продукты
            "еда", "продукт", "фрукт", "овощ", "мясо", "рыба", "птица",
            "хлеб", "булка", "мучное", "молоко", "сыр", "масло", "яйцо",
            "колбаса", "сосиски", "ветчина", "бекон", "стейк", "котлета",
            "бургер", "пицца", "паста", "рис", "гречка", "макароны",
            "суп", "борщ", "салат", "десерт", "торт", "пирог", "печенье",
            "конфета", "шоколад", "мороженое", "напиток", "сок", "вода", "чай", "кофе",
            "алкоголь", "вино", "пиво", "водка", "коньяк", "виски",
            # Одежда и ткани
            "одежда", "ткань", "обувь", "рубашка", "футболка", "майка", "свитер", "кофта",
            "куртка", "пальто", "шуба", "плащ", "брюки", "джинсы", "шорты",
            "юбка", "платье", "костюм", "галстук", "бабочка", "ремень",
            "носки", "чулки", "колготки", "бельё", "пижама", "халат",
            "рюкзак", "сумка", "портфель", "чемодан", "кейс",
            "шапка", "шляпа", "кепка", "берет", "панама", "косынка",
            "перчатки", "варежки", "шарф", "платок", "шарф",
            # Косметика и гигиена
            "косметика", "макияж", "помада", "тушь", "тени", "пудра", "крем",
            "лак", "лак для ногтей", "шампунь", "гель", "мыло", "зубная паста", "щётка",
            "бритва", "лезвие", "расчёска", "фен", "утюжок", "плойка",
            # Другие неестественные объекты
            "игрушка", "кукла", "машинка", "мяч", "кубик", "конструктор", "лего",
            "книга", "журнал", "газета", "тетрадь", "блокнот", "ручка", "карандаш",
            "деньги", "карта", "банкнота", "монета", "кошелёк", "кошелек",
            "ювелирка", "украшение", "кольцо", "цепочка", "серьга", "браслет",
            "часы", "наручные", "карманные", "настенные", "напольные",
            "пластик", "стекло", "металл", "дерево", "бумага", "картон",
            "резина", "пластмасса", "керамика", "фарфор", "хрусталь"
        ]
        ...
        # Если ответ слишком короткий и нет ключевых слов почвы
        if len(vision_result) < 30 and not has_soil_keyword:
            return {
                "error": "Загруженное изображение не содержит образца почвы. Пожалуйста, загрузите фото почвы или введите данные вручную"
            }
        
        # Если есть reject keywords - отклоняем
        if has_soil_keyword:
            # Если есть soil keyword - принимаем
            pass
        else:
            # Если нет soil keyword и ответ не слишком короткий - проверяем на reject keywords
            if len(vision_result) >= 30:
                # Дополнительная проверка на ключевые слова не-почвы (fallback)
                reject_keywords_strict = [
                    "кот", "кошка", "собака", "животное", "человек", "лицо", "рука", "нога", "голова",
                    "шерсть", "ус", "хвост", "лапа", "коготь", "мех"
                ]
                
                for keyword in reject_keywords_strict:
                    if keyword in result_lower:
                        return {
                            "error": "Загруженное изображение не содержит образца почвы. Пожалуйста, загрузите фото почвы или введите данные вручную"
                        }
