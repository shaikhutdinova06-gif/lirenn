...
async def process_block1(data):
    ...
    if images and len(images) > 0:
        ...
        reject_keywords = [
            ...
            "мебель", "стул", "стол", "машина", "дом", "здание", "автомобиль",
            "еда", "фрукт", "овощ", "мясо", "рыба", "птица", "еда",
            "одежда", "ткань", "обувь", "рюкзак", "сумка",
            "шерсть", "ус", "хвост", "лапа", "коготь"
        ]
        ...
        soil_keywords = [
            "почва", "грунт", "земля", "песок", "глина", "суглинок",
            "чернозём", "торф", "ил", "гумус", "почвенный"
        ]
